...
# TODO: 10s在场，然后撤退，18s冷却：砾，红，傀影
char_tree = {
    "Guard": {
        "Single Guard 1": ["玫兰莎"],
        "Single Guard 2": ["缠丸", "芙兰卡", "炎客", "断罪者"],
        "Single Guard 3": ["斯卡蒂"],
        "Support Guard 1": [],
        "Support Guard 2": ["杜宾", "诗怀雅"],
        "Support Guard 3": [],
        "Magic Guard 1": [],
        "Magic Guard 2": ["慕斯", "星极", "铸铁"],
        "Magic Guard 3": [],
        "Ranged Guard 1": ["月见夜"],
    ...
    "Vanguard": {
        ...
        "Supportive Vanguard 2": ["桃金娘", "极境"],
        "Supportive Vanguard 3": [],
        "Attack Vanguard 1": ["翎羽"],
        "Attack Vanguard 2": ["红豆", "格拉尼", "苇草"],
        "Attack Vanguard 3": ["风笛"],
    },
    "Support": {
